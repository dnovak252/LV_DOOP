...
namespace LV6
{
    class ToDoItem
    {
        private string title; private string text; private DateTime timeDue;

        public DateTime CreationTime { get; private set; }

        public ToDoItem(string title, string text, DateTime timeDue)
        {
            this.title = title; this.text = text; this.timeDue = timeDue;
        ...
        {
            this.title = previous.Title; this.text = previous.Text; this.timeDue = previous.TimeDue;
